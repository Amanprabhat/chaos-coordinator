...
exports.seed = async function (knex) {
  ...
  await knex('users').insert([
    { id: 1,  name: 'Admin User',      email: 'admin@demo.com',       role: 'Admin',  department: 'Management',        password_hash: DEMO_HASH, is_active: true, must_change_password: false },
    { id: 2,  name: 'John Sales',      email: 'sales@demo.com',       role: 'Sales',  department: 'Sales',             password_hash: DEMO_HASH, is_active: true, must_change_password: false },
    { id: 3,  name: 'Sarah CSM',       email: 'csm@demo.com',         role: 'CSM',    department: 'Customer Success',  password_hash: DEMO_HASH, is_active: true, must_change_password: false },
    { id: 4,  name: 'Mike PM',         email: 'pm@demo.com',          role: 'PM',     department: 'Project Management',password_hash: DEMO_HASH, is_active: true, must_change_password: false },
    { id: 5,  name: 'Client User',     email: 'client@demo.com',      role: 'Client', department: 'External',          password_hash: DEMO_HASH, is_active: true, must_change_password: false },
    { id: 6,  name: 'Priya CSM',       email: 'priya@demo.com',       role: 'CSM',    department: 'Customer Success',  password_hash: DEMO_HASH, is_active: true, must_change_password: false },
    { id: 7,  name: 'Alex PM',         email: 'alex.pm@demo.com',     role: 'PM',     department: 'Project Management',password_hash: DEMO_HASH, is_active: true, must_change_password: false },
    { id: 8,  name: 'Emma Product',    email: 'emma@demo.com',        role: 'PM',     department: 'Product',           password_hash: DEMO_HASH, is_active: true, must_change_password: false },
    { id: 9,  name: 'Raj Product',     email: 'raj@demo.com',         role: 'PM',     department: 'Product',           password_hash: DEMO_HASH, is_active: true, must_change_password: false },
    { id: 10, name: 'Lisa Product',    email: 'lisa@demo.com',        role: 'PM',     department: 'Product',           password_hash: DEMO_HASH, is_active: true, must_change_password: false },
  ]);
